...
kdialog --msgbox "Connect Phone to Computer Via USB - Make Sure Phone is Not in Sleep Mode nor Locked\n\nThen Click OK to Continue" --title "Connect Phone"
...
kdialog --msgbox "Disconnect USB Cable From Phone Now\n\nThen Click OK to Continue" --title "Attempting WiFi Connection"
# Pop-up Window with instructions
...
# If Scrcpy does not output "INFO", indicating it has not successfully launched
	...
	kdialog --msg "WiFi Connection to Phone Failed\n\nClick OK to Retry" --title "Phone Not Connected" 
	# Pop-up Window with instructions
	...
	# If Scrcpy does not output "INFO", indicating it has not successfully launched
		...
		kdialog --msg "WiFi Connection to Phone Twice Failed\n\nClick OK Exit" --title "Phone Not Connected"
		# Pop-up Window with instructions
